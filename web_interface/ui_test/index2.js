...
export function cropScaleGetImageData(mainContext, cropContext, scaledContext) {
    ...
    // var origBits = mainContext.getImageData(0, 0, 100, 100);
    // contrastImage(origBits, -.98);
    // mainContext.putImageData(origBits, 0, 0);
    ...
    // Create a reversed radial gradient
    const gradient = mainContext.createRadialGradient(0, 0, 0, 0, 0, canvas.width/2);
    gradient.addColorStop(0, "black"); // Darkest at the center
    gradient.addColorStop(1, "rgba(255, 255, 255, 0.8)"); // Lightest at the edges

    // Apply the gradient as a fill style and draw a rectangle
